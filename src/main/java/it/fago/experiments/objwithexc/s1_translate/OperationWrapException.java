 ...
 * @author Stefano Fago
 *
 * This is a Stackless Exception that not use
 * specific costructor from java7+: this class
 * force stackless by overidding of fillInStackTraceMethod
 * 
 */
public class OperationWrapException extends RuntimeException{
	 ...
	 * that is a Stackless Runtime Exception. The original stacktrace become
	 * the new exception stacktrace as the message.
	 * 
	 * 
	 * @param error
